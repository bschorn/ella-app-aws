package org.schorn.ella.impl.aws.file.s3;

public class AWSFileS3Write implements IAppWrite {
...
public class MakingRequests {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String accessPoint = "arn:aws:s3:us-east-1:071547842341:accesspoint/janebankref";
        String bucketName = "jane-bank.bank-ref";
